<template>
    <GuestLayout title="Faça login em sua conta">
            ...
            <form class="space-y-6" method="POST" @submit.prevent="login">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm">
                            <router-link :to="{name: 'requestPassword'}" class="font-semibold text-indigo-600 hover:text-indigo-500"> Esqueceu sua Senha? </router-link>
                        </div>
                    </div>
                </div>
                <div>
