        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            <div class="bg-white p-3 shadow rounded-lg md:col-span-2">
                <form x-data="{
                    ...
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Detalhes do Perfil</h2>
                    ...
                    <h2 class="text-xl mt-6 font-semibold mb-2">Endereço de Cobrança</h2>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                            <x-input
                                type="text"
                    ...
                    <div class="flex justify-between mt-6 mb-2">
                        <h2 class="text-xl font-semibold">Endereço para envio</h2>
                        <label for="sameAsBillingAddress" class="text-gray-700">
                            <input @change="$event.target.checked ? shippingAddress = {...billingAddress} : ''"
                                   ...
                                   class="text-purple-600 focus:ring-purple-600 mr-2"> O mesmo que de Cobrança
                        </label>
                    </div>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                    ...
                    <x-button class="w-full">Atualizar</x-button>
                </form>
            </div>
            <div class="bg-white p-3 shadow rounded-lg">
                <form action="{{route('profile_password.update')}}" method="post">
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Atualizar Senha</h2>
                    <div class="mb-3">
                        <x-input
                            type="password"
                            name="old_password"
