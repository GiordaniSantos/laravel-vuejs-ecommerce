        ...
        foreach ($products as $product) {
            ...
            $lineItems[] = [
                'price_data' => [
                    ...
                    'product_data' => [
                        'name' => $product->title,
//                        'images' => [$product->image] funciona quando estiver com o projeto no ar, pois a imagem está publica
                    ],
...
//        dd(route('checkout.success', [], true) . '?session_id={CHECKOUT_SESSION_ID}');
    ...
    public function success(Request $request)
    {
        ...
        try {
            ...
            if (!$session) {
                return view('checkout.failure', ['message' => 'ID da Sessão Inválido']);
            }
            ...
            //ver porque não ta pegando o costumer no stripe
